...
0 _notes tget 0.05 port 0.1 1 3 jitter + dup 0 pset
mtof 0.3 saw
...
1 _notes tget 0.02 port 6 0.2 _expr get * sine + mtof 0.3  1 1.001
_expr get 0.3 1.6 scale fm 1 _gates tget 0.01 0.1 1 0.2 adsr *


2 _notes tget 0.02 port 6.6 0.2 _expr get * sine + 
0.1 1 3 jitter + mtof  
...
_expr get -6 -4 scale ampdb *

_expr get 800 8000 scale butlp 
